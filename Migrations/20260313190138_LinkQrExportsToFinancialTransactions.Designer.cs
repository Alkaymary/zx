...
namespace MyApi.Migrations
{
    ...
    [Migration("20260313190138_LinkQrExportsToFinancialTransactions")]
    partial class LinkQrExportsToFinancialTransactions
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyApi.Models.FinancialTransaction", b =>
                {
                    ...
                    b.Property<int?>("CreatedByLibraryAccountId")
                        .HasColumnType("integer")
                        .HasColumnName("created_by_library_account_id");
                    ...
                    b.HasIndex("CreatedByLibraryAccountId");
            ...
            modelBuilder.Entity("MyApi.Models.QrCode", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("MyApi.Models.FinancialTransaction", b =>
                {
                    ...
                    b.HasOne("MyApi.Models.LibraryAccount", "CreatedByLibraryAccount")
                        .WithMany()
                        .HasForeignKey("CreatedByLibraryAccountId")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.Navigation("CreatedByLibraryAccount");
            ...
            modelBuilder.Entity("MyApi.Models.QrCode", b =>
                {
                    ...
                    b.HasOne("MyApi.Models.FinancialTransaction", "FinancialTransaction")
                        .WithMany("QrCodes")
                    ...
                    b.HasOne("MyApi.Models.Package", "Package")
                        .WithMany()
                        .HasForeignKey("PackageId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("MyApi.Models.PosDevice", "PosDevice")
                        .WithMany()
